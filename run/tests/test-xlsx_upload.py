...
url = "http://localhost:8000/api/grades/uploadXlsxOpen"
...
with open(file_path, "rb") as f:
    files = {
        "file": ("grades.xlsx", f, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
    }
    response = requests.post(url, files=files)
